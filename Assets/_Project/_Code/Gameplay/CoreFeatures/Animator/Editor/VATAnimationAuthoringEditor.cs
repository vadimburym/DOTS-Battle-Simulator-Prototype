...
{
    [CustomEditor(typeof(VATAnimatorAuthoring))]
    public sealed class VATAnimationAuthoringEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            var authoring = (VATAnimatorAuthoring)target;
        ...
        private static void DrawClipPopup(VATAnimatorAuthoring authoring, int meshIndex)
        {
